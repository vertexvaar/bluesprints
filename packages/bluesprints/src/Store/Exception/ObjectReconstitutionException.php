...
class ObjectReconstitutionException extends BluesprintsException
{
    ...
    public function __construct(string $class, string $uuid, Throwable $previous = null)
    {
        $this->class = $class;
        $this->uuid = $uuid;
        parent::__construct("The object $class $uuid could not be reconstituted", self::CODE, $previous);
    }
